...
<form action="../PositionChangeServlet" method="post">
            <!-- Unnamed (提交按钮) -->
            <div id="u456" class="ax_default html_button">
              <input id="u456_input" type="submit" name="task" value="查询"/>
            </div>
            ...
            <div id="u458" class="ax_default text_field">
              <input id="u458_input" type="text" name="changePosition_position_from" value="${changePosition_position_from} " readonly/>
            </div>

            <!-- Unnamed (提交按钮) -->
            <div id="u459" class="ax_default html_button">
              <input id="u459_input" type="submit" name="task" value="提交"/>
            </div>
            ...
            <div id="u461" class="ax_default text_field">
              <input id="u461_input" type="text" name="people_id" value=""/>
            </div>
            ...
            <div id="u467" class="ax_default text_area">
              <textarea id="u467_input" name="position_change_reason"></textarea>
            </div>
            ...
            <div id="u469" class="ax_default text_field">
              <input id="u469_input" name="changePosition_position_to" type="text" value=""/>
            </div>
            ...
            <div id="u476" class="ax_default text_field">
              <input id="u476_input" name="changePosition_staff_name" type="text" value="${changePosition_staff_name}" readonly/>
            </div>
            ...
            <div id="u478" class="ax_default text_field">
              <input id="u478_input" name="changePosition_staff_id" type="text" value="${changePosition_staff_id}" readonly/>
            </div>
</form>
          </div>
        </div>
