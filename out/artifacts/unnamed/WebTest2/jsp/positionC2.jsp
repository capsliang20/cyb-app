<%@page import="com.entity.ChangePositionRecord"%>
...
<form action="../GetPositionChangeInfoServlet" method="post">
            ...
            <!-- Unnamed (文本框) -->
            <div id="u529" class="ax_default text_field">
              <input id="u529_input" name="staff_id" type="text" value=""/>
            </div>
...
<input id="pu73_input" name="currentPage" type="text" style="display:none" value="1"/>
            ...
            <div id="u492" class="ax_default button">
              ...
              <input id="u492_div" type="submit" value="查询"/>
            </div>
...
%>
<%
if((List<ChangePositionRecord>)request.getAttribute("list")!=null) {
	String depart_name=(String)request.getAttribute("depart_name");
	List<ChangePositionRecord> list=(List<ChangePositionRecord>)request.getAttribute("list");
	if(list.size()>0){	
		...
		ChangePositionRecord staff=null;
//----------------------------------------------------------------------------------------------------------
		if(0<list.size()){
			staff=list.get(0);
			if(staff!=null){
              ...
              <div id="u504" class="ax_default table_cell">
                ...
                <div id="u504_img" class="text">
                <p><%=staff.getPosition_from() %></p>
                </div>
              </div>
              ...
              <div id="u505" class="ax_default table_cell">
                ...
                <div id="u505_img" class="text">
                <p><%=staff.getPosition_to() %></p>
                </div>
              </div>
		...
		if(3<list.size()){
			...
			if(staff!=null){
              ...
              <div id="u517" class="ax_default table_cell">
                <img id="u517_img" class="img " src="images/离职管理/u284.png"/>
                <div id="u507_img" class="text">
                <p><%=staff.getStaff_id() %></p>
                </div>
              </div>
              ...
              <div id="u518" class="ax_default table_cell">
                <img id="u518_img" class="img " src="images/离职管理/u284.png"/>
                <div id="u507_img" class="text">
                <p><%=staff.getStaff_name() %></p>
                </div>
              </div>
              ...
              <div id="u519" class="ax_default table_cell">
                <img id="u519_img" class="img " src="images/离职管理/u284.png"/>
                <div id="u507_img" class="text">
                <p><%=staff.getPosition_from() %></p>
                </div>
              </div>
              ...
              <div id="u520" class="ax_default table_cell">
                <img id="u520_img" class="img " src="images/离职管理/u284.png"/>
                <div id="u507_img" class="text">
                <p><%=staff.getPosition_to() %></p>
                </div>
              </div>
              ...
              <div id="u521" class="ax_default table_cell">
                <img id="u521_img" class="img " src="images/离职管理/u292.png"/>
                <div id="u507_img" class="text">
                <p><%=staff.getDate() %></p>
                </div>
              </div>
...
<form action="../GetPositionChangeInfoServlet" method="post">
            ...
            <div id="u527" class="ax_default button">
              ...
              <input id="u527_div" type="submit" value="上一页"/>
            </div>
...
<form action="../GetPositionChangeInfoServlet" method="post">
            ...
            <div id="u528" class="ax_default button">
              ...
              <input id="u528_div" type="submit" value="下一页"/>
            </div>
            <input name="staff_id" type="text" style="display:none" value="<%=staff.getStaff_id() %>"/>
			<input name="currentPage" type="text" style="display:none" value="<%=currentPage+1%>"/>
</form>
