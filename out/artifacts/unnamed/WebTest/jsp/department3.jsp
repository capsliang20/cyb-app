...
<head>
    ...
    <link href="files/部门管理_删除部门/styles.css" type="text/css" rel="stylesheet"/>
    <script src="resources/scripts/jquery-1.7.1.min.js"></script>
    <script src="resources/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script src="resources/scripts/prototypePre.js"></script>
    <script src="data/document.js"></script>
    <script src="resources/scripts/prototypePost.js"></script>
    <script src="files/部门管理_删除部门/data.js"></script>
...
<form  action="../DepartDeleteAct"  method="post">
            <!-- Unnamed (矩形) -->
            ...
            <div id="u40" class="ax_default text_field">
              <input id="u40_input" type="text" name="depart_id" />
            </div>

            <!-- Unnamed (文本框) -->
            <div id="u41" class="ax_default text_field">
              <input id="u41_input" type="text" name="depart_name" />
            </div>

            <!-- Unnamed (提交按钮) -->
            <div id="u42" class="ax_default html_button">
              <input id="u42_input" type="submit" value="删除部门"/>
            </div>
</form>
            <!-- Unnamed (水平线) -->
            <div id="u43" class="ax_default line">
              <img id="u43_img" class="img " src="images/部门管理_新建部门/u1.png"/>
            </div>
