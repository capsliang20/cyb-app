...
<form  action="../DepartInsertAct"  method="post">
            <!-- Unnamed (矩形) -->
            ...
            <div id="u6" class="ax_default text_field">
              <input id="u6_input" name="depart_id" type="text" value=""/>
            </div>

            <!-- Unnamed (文本框) -->
            <div id="u7" class="ax_default text_field">
              <input id="u7_input" name="depart_name" type="text" value=""/>
            </div>

            <!-- Unnamed (文本框) -->
            <div id="u8" class="ax_default text_field">
              <input id="u8_input" type="depart_tel" value=""/>
            </div>
            ...
            <div id="u11" class="ax_default text_field">
              <input id="u11_input" name="depart_fax" type="text" value=""/>
            </div>
            ...
            <div id="u13" class="ax_default text_field">
              <input id="u13_input" name="build_date" type="date" value=""/>
            </div>
            ...
            <div id="u16" class="ax_default text_area">
              <textarea id="u16_input" name="depart_describe"></textarea>
            </div>
</form>
${msg }
          </div>
