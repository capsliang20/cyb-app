        ...
        <div id="u394_state0" class="panel_state" data-label="State1" style="">
          <div id="u394_state0_content" class="panel_state_content">
            ...
            <div id="u440" class="ax_default text_field">
              <input id="u440_input" type="date" value=""/>
            </div>
            ...
            <div id="u442" class="ax_default text_field">
              <input id="u442_input" type="date" value=""/>
            </div>
            ...
            <div id="u447" class="ax_default text_field">
              <input id="u447_input" type="text" value=""/>
            </div>
            ...
            <!-- Unnamed (下拉列表框) -->
            <div id="u451" class="ax_default droplist">
              <select id="u451_input">
              </select>
            </div>
          </div>
        </div>
