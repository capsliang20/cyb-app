...
<head>
    ...
    <link href="files/岗位管理_删除岗位/styles.css" type="text/css" rel="stylesheet"/>
    <script src="resources/scripts/jquery-1.7.1.min.js"></script>
    <script src="resources/scripts/jquery-ui-1.8.10.custom.min.js"></script>
    <script src="resources/scripts/prototypePre.js"></script>
    <script src="data/document.js"></script>
    <script src="resources/scripts/prototypePost.js"></script>
    <script src="files/岗位管理_删除岗位/data.js"></script>
        ...
        <div id="u104_state0" class="panel_state" data-label="State1" style="">
          <div id="u104_state0_content" class="panel_state_content">
            ...
            <div id="u105" class="ax_default line">
              <img id="u105_img" class="img " src="images/部门管理_新建部门/u1.png"/>
            </div>
...
<form  action="../PositionDeleteAct"  method="post">
            <!-- Unnamed (文本框) -->
            <div id="u110" class="ax_default text_field">
              <input id="u110_input" name="position_id" type="text" value=""/>
            </div>

            <!-- Unnamed (文本框) -->
            <div id="u111" class="ax_default text_field">
              <input id="u111_input" name="position_name" type="text" value=""/>
            </div>

            <!-- Unnamed (提交按钮) -->
            <div id="u112" class="ax_default html_button">
              <input id="u112_input" type="submit" value="提交"/>
            </div>
</form>
          </div>
        </div>
