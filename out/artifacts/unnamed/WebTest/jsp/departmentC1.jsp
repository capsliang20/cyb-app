        ...
        <div id="u363_state0" class="panel_state" data-label="State1" style="">
          <div id="u363_state0_content" class="panel_state_content">
            ...
            <div id="u369" class="ax_default text_field">
              <input id="u369_input" type="text" value=""/>
            </div>
            ...
            <div id="u374" class="ax_default text_field">
              <input id="u374_input" type="text" value=""/>
            </div>

            <!-- Unnamed (文本框) -->
            <div id="u375" class="ax_default text_field">
              <input id="u375_input" type="text" value=""/>
            </div>
            ...
            <div id="u378" class="ax_default html_button">
              <input id="u378_input" type="submit" value="查询"/>
            </div>

            <!-- Unnamed (提交按钮) -->
            <div id="u379" class="ax_default html_button">
              <input id="u379_input" type="submit" value="提交"/>
            </div>
            ...
            <div id="u387" class="ax_default text_field">
              <input id="u387_input" type="text" value=""/>
            </div>
            ...
            <div id="u390" class="ax_default text_field">
              <input id="u390_input" type="text" value=""/>
            </div>
            ...
            <div id="u392" class="ax_default text_area">
              <textarea id="u392_input"></textarea>
            </div>

            <!-- Unnamed (下拉列表框) -->
            <div id="u393" class="ax_default droplist">
              <select id="u393_input">
              </select>
            </div>
          </div>
        </div>
